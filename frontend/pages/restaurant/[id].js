    ...
    <div className="w-full md:w-1/2 lg:w-1/3 p-4">
      <div className="h-full bg-gray-100 rounded-2xl">
        <Image
          ...
          height={300}
          width={300}
          src={`${process.env.STRAPI_URL || "https://strapi-9s4s.onrender.com"}${
    ...
    return (
      <div className="py-6">
        ...
        <div className="py-8">
          <input
            type="text"
            className="w-full px-4 py-2 border-gray-300 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
